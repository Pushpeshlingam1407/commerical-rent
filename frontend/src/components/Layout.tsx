  ...
  const getMenuItems = () => {
    ...
    switch (user.role) {
      ...
      case 'PROPERTY_OWNER':
        return [
          { text: 'Dashboard', icon: <Dashboard />, path: '/' },
          { text: 'My Properties', icon: <HomeWork />, path: '/owner/properties' },
        ];
      case 'TENANT':
        return [
          { text: 'Dashboard', icon: <Dashboard />, path: '/' },
          { text: 'Browse Properties', icon: <HomeWork />, path: '/tenant/browse' },
          { text: 'My Payments', icon: <Payment />, path: '/tenant/payments' },
        ];
      case 'LEASE_MANAGER':
        return [
          { text: 'Lease Approvals', icon: <Description />, path: '/' },
        ];
      case 'DISPUTE_MANAGER':
        return [
          { text: 'Disputes', icon: <Gavel />, path: '/' },
        ];
      default:
        return [];
    }
      ...
      >
        <Toolbar>
          ...
          <div>
            ...
            >
              <MenuItem onClick={handleLogout} sx={{ color: 'var(--status-error-text)' }}>
      ...
      >
        <Drawer
          ...
          sx={{
            ...
            '& .MuiDrawer-paper': { boxSizing: 'border-box', width: drawerWidth, borderRight: 'none', boxShadow: 'var(--shadow-md)' },
          }}
        >
          {drawer}
        </Drawer>
